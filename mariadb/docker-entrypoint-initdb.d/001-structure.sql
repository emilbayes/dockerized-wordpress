...
DROP TABLE IF EXISTS `dwp_commentmeta`;
CREATE TABLE `dwp_commentmeta` (
...
DROP TABLE IF EXISTS `dwp_comments`;
CREATE TABLE `dwp_comments` (
...
DROP TABLE IF EXISTS `dwp_links`;
CREATE TABLE `dwp_links` (
...
DROP TABLE IF EXISTS `dwp_options`;
CREATE TABLE `dwp_options` (
...
LOCK TABLES `dwp_options` WRITE;
INSERT INTO `dwp_options` VALUES
  (1,'siteurl','','yes'),
  (2,'home','','yes'),
  (3,'blogname','WordPress Blog','yes'),
...
DROP TABLE IF EXISTS `dwp_postmeta`;
CREATE TABLE `dwp_postmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `dwp_posts`;
...
DROP TABLE IF EXISTS `dwp_term_relationships`;
CREATE TABLE `dwp_term_relationships` (
...
DROP TABLE IF EXISTS `dwp_term_taxonomy`;
CREATE TABLE `dwp_term_taxonomy` (
...
DROP TABLE IF EXISTS `dwp_termmeta`;
CREATE TABLE `dwp_termmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `term_id` bigint(20) unsigned NOT NULL DEFAULT '0',
  `meta_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_value` longtext COLLATE utf8mb4_unicode_ci,
...
DROP TABLE IF EXISTS `dwp_terms`;
CREATE TABLE `dwp_terms` (
...
DROP TABLE IF EXISTS `dwp_usermeta`;
CREATE TABLE `dwp_usermeta` (
...
DROP TABLE IF EXISTS `dwp_users`;
CREATE TABLE `dwp_users` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
